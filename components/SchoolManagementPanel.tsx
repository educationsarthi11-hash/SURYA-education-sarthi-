    ...
    sections: [
      {
        ...
        services: ['Smart Admissions', 'Student Database', 'Lead Generator', 'AI Certificate Generator', 'Digital Locker'] as ServiceName[]
      },
      {
      ...
      },
      {
        ...
        services: ['Fee Management', 'Fee Notification', 'Auto-Dialer', 'Smart HR Manager', 'Profit Calculator'] as ServiceName[]
      },
      {

...
const CurriculumArchitect: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const result = await generateCurriculum(className, subject, board, durationWeeks);
                ...
                <div className="lg:col-span-1 bg-slate-50 p-6 rounded-xl border border-slate-200 h-fit overflow-y-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value={subject} onChange={e => setSubject(e.target.value)} className="mt-1 w-full p-2 border rounded-md" placeholder="e.g. Physics, History"/>
                        </div>
                        <div>

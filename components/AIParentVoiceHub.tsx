            ...
            <div className="w-full max-w-md flex flex-col items-center gap-8 mb-4">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex gap-2">
                        <span className="bg-slate-100 px-3 py-1 rounded-full text-[10px] font-black uppercase text-slate-500 tracking-widest border">Mode: {selectedLanguage.nativeName}</span>
                    </div>
                </div>
            </div>

            <div className="w-full border-t pt-8 flex justify-center gap-6">
                <a href="tel:9053144592" className="flex items-center gap-3 bg-green-50 text-green-700 px-8 py-3 rounded-2xl font-black text-xs uppercase tracking-widest border border-green-200 hover:bg-green-100 transition-all">
                    <PhoneIcon className="h-5 w-5"/> Admin Call
                </a>
            </div>
        </div>
    );

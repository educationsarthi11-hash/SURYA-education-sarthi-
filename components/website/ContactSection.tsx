        ...
        <SectionWrapper id="contact" className="bg-gradient-radial-at-top">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                <div className="lg:col-span-1 space-y-8">
                    ...
                    <div className="flex items-start gap-4"><PhoneIcon aria-hidden="true" className="h-8 w-8 text-primary flex-shrink-0 mt-1" /><div><h4 className={`font-semibold ${isHindi ? 'font-hindi' : ''}`}>{t('Call Us', 'कॉल करें')}</h4><a href="tel:919053144592" className="text-slate-600 hover:text-primary transition-colors">+91 90531 44592</a></div></div>

        ...
        <div className="space-y-4 animate-pop-in h-full overflow-y-auto pr-2 custom-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="subject" id="subject" value={config.subject} onChange={handleConfigChange} className="mt-1 block w-full rounded-md border-neutral-300 shadow-sm p-2" />
                </div>
                <div className="md:col-span-2">
                    <label htmlFor="chapterName" className="block text-sm font-medium text-neutral-700">Chapter Name</label>
                    <input type="text" name="chapterName" id="chapterName" value={config.chapterName} onChange={handleConfigChange} className="mt-1 block w-full rounded-md border-neutral-300 shadow-sm p-2" />
                </div>
            </div>
            <div>

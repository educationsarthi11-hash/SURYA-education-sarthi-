...
import { VideoCameraIcon, FilmIcon, SparklesIcon, PlayIcon, ArrowRightIcon, XCircleIcon, PencilSquareIcon, ArrowDownTrayIcon } from './icons/AllIcons';
                      ...
                      <div className="max-w-2xl mx-auto space-y-6">
                          <div className="space-y-2">
                              <div className="flex justify-between items-center ml-4">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Video Topic</label>
                                <button 
                      ...
                      <div className="max-w-2xl mx-auto space-y-8 text-center">
                          ...
                          {videoUrl && (
                              <div className="mt-12 bg-slate-950 rounded-[4rem] p-6 shadow-2xl border-8 border-slate-900 animate-pop-in relative">
                                  <button onClick={() => setVideoUrl('')} className="absolute -top-4 -right-4 bg-red-500 text-white p-2 rounded-full shadow-lg hover:scale-110 transition-transform"><XCircleIcon className="h-7 w-7"/></button>
